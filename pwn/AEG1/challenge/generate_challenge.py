...
for round_number in range(N, 0, -1):
    ...
    if N < 21:
        generate_level_one_source_code(filename_stem="binary_{}".format(round_number), password=password)
        os.system("gcc -m32 -fno-stack-protector -fpie -no-pie binary_{0}.c -o binary_{0}".format(round_number))
        ...
        print("Levels higher than one are unsupported at this time!")
        exit(0)
